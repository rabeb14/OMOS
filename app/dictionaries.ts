...
export const dict = {
  ...
  fr: {
    ...
    hero: {
      title1: "Solutions de Maintenance",
      title2: "Industrielle Haute Performance",
      subtitle: "Forts de plusieurs décennies d'expertise dans le secteur pétrolier et gazier, nous garantissons fiabilité, sécurité et excellence opérationnelle.",
      discover: "Découvrir",
