...
export default function History() {
  ...
  const milestones = [
    { date: d.milestone1?.date || "1997-2017", title: d.milestone1?.title || "Experience", content: d.p1 },
    { date: d.milestone2?.date || "2017", title: d.milestone2?.title || "ETPAK", content: d.p2 },
    { date: d.milestone3?.date || "2022", title: d.milestone3?.title || "OMOS", content: d.p3 },
    { date: d.milestone4?.date || "2026", title: d.milestone4?.title || "Expansion", content: d.p4 }
  ];
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-4">
        ...
        >
          <h2 className="text-2xl md:text-4xl font-bold text-blue-900 dark:text-white uppercase tracking-tight">
            {d.title}
          </h2>
        ...
        <div className="relative mb-12 px-4 " >
          ...
          {/* Pipeline */}
          <div className="absolute top-1/2 left-0 right-0 h-3 bg-gradient-to-b from-gray-300 via-gray-100 to-gray-400 dark:from-slate-800 dark:via-slate-600 dark:to-slate-900 -translate-y-1/2 rounded-full border border-gray-400/20 dark:border-white/5 shadow-inner">
            <motion.div
              initial={false}
              animate={{
                width: `calc(${(activeIndex / (milestones.length - 1)) * 100}% + ${activeIndex === 0
                  ? "0px"
              ...
              className="h-full bg-gradient-to-r from-blue-600 to-blue-400 rounded-full relative overflow-hidden"
            >
              <div className="absolute inset-1 bg-[linear-gradient(90deg,transparent_0%,rgba(255,255,255,0.3)_50%,transparent_100%)] animate-[shimmer_2s_infinite]" />
            </motion.div>
          </div>
            ...
            {milestones.map((m, index) => (
              <div key={index} className="flex flex-col items-center mb-9">
                ...
                <motion.span
                  ...
                  className={`text-xs font-bold mb-5 ${activeIndex === index
                ...
                >
                  <div
                    className={`w-7 h-7 rounded-full border-2 flex items-center justify-center transition-all duration-300 ${activeIndex === index
                      ? "bg-white dark:bg-blue-500 border-blue-600 dark:border-white scale-105"
                  ...
                  <motion.span
                    animate={{ opacity: activeIndex === index ? 1 : 0 }}
                    className="absolute top-10 md:top-11 
text-[10px] sm:text-xs md:text-sm lg:text-base 
font-bold uppercase tracking-wide 
text-blue-900/60 dark:text-blue-300/60 
        ...
        <div className="relative max-w-2xl mx-auto min-h-[200px]">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="bg-white dark:bg-blue-900/20 backdrop-blur-xl p-6 rounded-3xl border border-gray-100 dark:border-blue-800/50 shadow-xl"
            >
              <div className="flex flex-col md:flex-row gap-5 items-start">
                <div className="hidden md:block w-1 h-16 bg-gradient-to-b from-blue-600 to-transparent rounded-full" />
